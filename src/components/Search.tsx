    ...
    return (
        <form className="w-full bg-[#FEFEFE] dark:bg-[#1E2A47] shadow-light dark:shadow-none rounded-2xl flex items-center mb-6">
            <div className="py-[22px] pl-8 flex flex-1">
                ...
                <input className="ml-6 pr-1 placeholder:text-[#4B6A9B] caret-[#0079FF] flex-1 outline-none font-light text-lg dark:bg-inherit dark:text-white" placeholder="Search GitHub username..." type="text" name="" id="" />
            </div>
