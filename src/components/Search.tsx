...
export const Search = ({ handleSetSearchData }: any) =>
{
    ...
    useEffect(() =>
    {
        if (gitUserData) handleSetSearchData(gitUserData)
    }, [gitUserData, handleSetSearchData])

    return (
        <form onSubmit={handleSubmit} className="w-full bg-[#FEFEFE] dark:bg-[#1E2A47] shadow-light dark:shadow-none rounded-2xl flex items-center mb-6">
