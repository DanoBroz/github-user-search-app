...
export const UserCard = (userData: DefaultData) => {
    return (
        <div className='user-card p-6 sm:p-10 md:p-12 shadow-light bg-white rounded-[10px] dark:bg-[#1E2A47] dark:shadow-none'>
            ...
            <div className='user-main transition-colors flex mb-[33px] sm:mb-[24px] md:mb-[20px]'>
                ...
                <div className='flex flex-col md:w-full md:flex-row md:justify-between'>
                    <div className='flex flex-col'>
                        ...
                        <span className='text-[13px] sm:text-[1rem] text-[#0079FF]'>@{userData?.login}</span>
                    </div>
                    <span className='text-[#4B6A9B] dark:text-white md:pt-2 text-[13px] sm:text-[15px]'>
