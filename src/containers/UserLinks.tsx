...
export const UserLinks = (userData: UserLinksProps) => {
    return (
        <div className={`grid gap-y-[15px] user-links`}>
            <UserLink content={userData?.location || 'Not Available'}>
            ...
            >
                <svg className='w-5 fill-[#4b6a9b] dark:fill-white' height='18' width='20' xmlns='http://www.w3.org/2000/svg'>
            ...
            <UserLink content={userData?.blog || 'Not Available'} href={userData?.blog}>
                <svg className='w-5 fill-[#4b6a9b] dark:fill-white' height='20' width='20' xmlns='http://www.w3.org/2000/svg'>
                    <g>
            ...
            <UserLink content={userData?.company || 'Not Available'}>
                <svg className='w-5 fill-[#4b6a9b] dark:fill-white' height='20' width='20' xmlns='http://www.w3.org/2000/svg'>
                    <g>
