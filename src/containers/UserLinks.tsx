...
export const UserLinks = (userData: UserLinksProps) => {
    return (
        <div className={`grid sm:grid-cols-2 gap-y-[15px] user-links`}>
            <a className='flex items-center gap-4 text-[#4B6A9B] dark:text-white' href='#'>
            ...
            <a
                className='flex items-center gap-4 text-[#4B6A9B] dark:text-white'
                href={userData?.blog ? `https://twitter.com/${userData?.blog}` : '#'}
            >
                ...
                <span className='truncate'>{userData?.blog || 'Not Available'}</span>
            </a>
